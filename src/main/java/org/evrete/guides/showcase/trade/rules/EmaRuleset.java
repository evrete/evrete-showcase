package org.evrete.guides.showcase.trade.rules;
...
import org.evrete.guides.showcase.trade.dto.Candle;
import org.evrete.guides.showcase.trade.dto.MessagingGateway;
import org.evrete.guides.showcase.trade.dto.PriceIndicator;
import org.evrete.guides.showcase.trade.dto.SessionConfig;
...
public class EmaRuleset extends Constants {
    ...
    public record EmaConfig(String name, int smoothingRange) {
    }
}
